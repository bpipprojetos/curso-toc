            ...
            <div className="space-y-6">
              ...
              >
                ...
                <ul className="space-y-6">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-300 text-lg">07/11/2025 — 18h às 22h via Zoom</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-white mt-1 shrink-0" />
              ...
              >
                ...
                <ul className="space-y-6">
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-white mt-1 shrink-0" />
                    <span className="text-gray-300 text-lg">08/11/2025 — 8h às 18h (10h intensivas)</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="w-5 h-5 text-white mt-1 shrink-0" />
        ...
        <div className="container relative z-10 max-w-5xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <button className="w-full py-4 rounded-lg border border-primary text-primary font-bold hover:bg-primary hover:text-black transition-all uppercase tracking-wide text-sm">
                Inscrever no Online
              </button>
            </motion.div>
            ...
            >
              ...
              <NeonButton className="w-full py-4 text-base">
      ...
      <section className="py-20 bg-black border-t border-zinc-900">
        <div className="container max-w-4xl text-center space-y-8">
          ...
          <div className="pt-4">
            <button
              onClick={scrollToPricing}
              className="bg-[#00D62F] hover:bg-[#00bd29] text-black font-bold text-xl py-5 px-12 rounded-full transition-transform transform hover:scale-105 shadow-[0_0_30px_rgba(0,214,47,0.3)]"
            >
